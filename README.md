...
I added a REST endpoint to create a new employee with dependents so that I could enforce the requirement about the number of domestic partners and spouses an employee could have. 
If I had more time I would have used the Entity Framework and a SQL Lite database for persistant storage.  
